...
{
  int i;
  /* create pointers to use during indexing */
  int *p1, *p2, *p3, *p4;
  /*
  assign pointers to point to locations of three successive spots in board
  */
  p1 = board;
  p2 = board + 1;
  p3 = board + 2;
  ...
  for (i = 1; i < len - 1; i++)
  {
    /* assign another to point to location of spot to write to */
    p4 = newboard + i;
